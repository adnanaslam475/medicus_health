...
import { useDoctorQuestionnaireQuery } from "../../../generated/graphql";
import { useRouter } from "next/router";

function PhysicianQuestionnaire() {
  ...
  let questionnair = [
    ...
    {
      label:
        "On a scale of 0-5 (0 is not at all, 5 is intolerable) how badly does your problem bother you?",
      name: "problem",
      type: "radio",
      options: [
        {
    ...
    {
      label:
        "Have you changed your lifestyle or activities because of your respiratory problem?",
    ...
    {
      label:
        "Do you have a history of, or have you been exposed to, tuberculosis (TB)?",
      name: "tuberculosis",
      type: "radio",
      options: [
        {
    ...
    {
      label:
        "Have you ever been in the hospital because of breathing problems?",
      name: "knownExposure",
      type: "radio",
      options: [
        {
    ...
    {
      label:
        "Please list any known exposure to asbestos, fumes, toxins, heavy metals, grinding, solvents, etc.:",
      name: "howLong",
      type: "text",
    },
  ];
  return (
    <Form
      layout="vertical"
      //  form={formInstance} onFinish={onFinishLocal}
    >
      {/* <Form.Item>
    ...
    //       <Form.Item label="Please explain" className="text-secondary">
    //         <Input />
    //       </Form.Item>

    //       <Form.Item label="Do you have a cough?" className="text-secondary">
    //         <Radio.Group>
    //           <Radio value={0}>Yes</Radio>
    //           <Radio value={1}>No</Radio>
    //         </Radio.Group>
    ...
    //       <Form.Item label="Do you wheeze?" className="text-secondary">
    //         <Radio.Group>
    //           <Radio value={0}>Yes</Radio>
    //           <Radio value={1}>No</Radio>
    //         </Radio.Group>
    ...
    //         </Radio.Group>
    //       </Form.Item>
    //       <Form.Item label="What and for how long?" className="text-secondary">
    //         <Input />
    //       </Form.Item>
    ...
    //         </Radio.Group>
    //       </Form.Item>
    //       <Form.Item label="Please describe." className="text-secondary">
    //         <Input />
    //       </Form.Item>
