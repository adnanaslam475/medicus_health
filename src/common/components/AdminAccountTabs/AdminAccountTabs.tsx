...
import _classes from "./AdminAccountTabs.module.scss";
    ...
    <div>
      <div className={`${_classes["mobile-tabs"]} profile-tabs card-container`}>
        <Tabs type="card">
          ...
          <Tabs.TabPane
            tab={<span className="font-Circular font-medium">Earnings</span>}
            key="3"
          >
            {/* <PaymentMethods /> */}
          </Tabs.TabPane>
          <Tabs.TabPane
            tab={<span className="font-Circular font-medium">Staff</span>}
            key="4"
          >
