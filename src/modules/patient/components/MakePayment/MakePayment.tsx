	...
	return (
		...
		<Form layout="vertical">
			<div>
				...
				<div className="flex items-center">
					...
					<span className="text-primary">Ad Payment Method</span>
				</div>
				<div className="flex justify-end">
					<Button type="primary" className={`${_Classes["button-color"]}`}>
						Pay $5900
					</Button>
				</div>
			</div>
		  ...
		  <Form.Item label="Address" className="flex ">
	  ...
	  <Form.Item className="inline w-1/4 " name="cvv" label ="Cvv" rules={[{ required: true, message: 'Username is required' }]}>
		  ...
		  <div className="flex justify-between items-center">
			  <span className="text-primary"><LeftOutlined className="mb-2" />Previous</span>
			  <Button>Pay $59.00</Button>
		  </div>
		</>
	);
}
