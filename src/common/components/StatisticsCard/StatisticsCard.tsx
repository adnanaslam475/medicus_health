...
function StatisticsCard({ src, title, value }: Props) {
	return (
		<div
			className={`bg-gray-4 border border-gray-4 flex gap-2 flex-col shadow-md py-20 px-4 mx-4 my-3`}
		>
			...
			<div className="text-6xl mx-auto px-auto text-center">{value}</div>
